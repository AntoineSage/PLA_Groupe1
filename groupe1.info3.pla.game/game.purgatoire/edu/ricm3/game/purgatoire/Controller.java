...
public class Controller extends GameController implements ActionListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_RIGHT:
			m_model.m_player.move(IDirection.EAST);
			break;
		case KeyEvent.VK_LEFT:
			m_model.m_player.move(IDirection.WEST);
			break;
		case KeyEvent.VK_UP:
			m_model.m_player.move(IDirection.NORTH);
			break;
		case KeyEvent.VK_DOWN:
			m_model.m_player.move(IDirection.SOUTH);
			break;
		}
