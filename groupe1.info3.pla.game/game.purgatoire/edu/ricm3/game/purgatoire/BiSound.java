...
/**
 * Class for playing two sounds alternatively.
 * Use "swap" to change from one sound to the other.
 * Caution; this is a singleton class. 
 */
public class BiSound {

    /**
     * Set the sound played.
     * true = sound 1
     * false = sound 2
     */
    ...
    /**
     * Shared variable for stopping the thread.
     * Calling thread.stop is unsafe :
